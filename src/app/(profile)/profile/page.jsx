    ...
    return (
      <article>
        ...
        <div>
          ...
          {payments.length ? <div className="shadow-sm overflow-auto my-4">
          ...
          </div> : <div className="flex flex-col items-center justify-center mt-4">
            <p className="text--white font-bold text-lg mb-4">سفارشی وجود ندارد</p>
