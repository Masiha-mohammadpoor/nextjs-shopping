...
const Products = async ({ searchParams }) => {
  ...
  return (
    <section className="grid grid-cols-4">
      ...
      <article className="w-[100%] row-start-1 lg:row-start-auto pt-10 md:pt-14 md:pb-20 md:h-screen grid grid-cols-12 col-span-4 lg:col-span-3 gap-5 gap-y-16 md:p-5 overflow-y-scroll">
        {products.map((p) => {
          return (
            <div
